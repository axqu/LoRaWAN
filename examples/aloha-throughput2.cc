...
main (int argc, char *argv[])
{
  ...
  cmd.AddValue ("SpreadFactor", "Spreading Factor", SpreadFactor);
  //cmd.AddValue ("packetSize", "Packet Size", packetSize);
  //cmd.AddValue ("realisticChannelModel", "Realistic Channel Model", realisticChannelModel);
  cmd.Parse (argc, argv);
...
//LogComponentEnable ("BuildingPenetrationLoss", LOG_LEVEL_ALL);
  ...
  Config::SetDefault ("ns3::EndDeviceLorawanMac::DataRate", UintegerValue (SpreadFactor));
   ...
   *  Create the channel  *
   ************************/
  NS_LOG_DEBUG ("Create the channel");
...
NS_LOG_DEBUG ("Channel created");
  ...
  NS_LOG_DEBUG ("SF: " << SpreadFactor);
  NS_LOG_DEBUG ("radius: " << radius);
